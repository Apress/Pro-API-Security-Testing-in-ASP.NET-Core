    ...
    public async Task ThirdPartyApi_GraphQLIntrospection_InformationDisclosure(string accountId)
    {
        ...
        var client = _factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureServices(services =>
            {
                ...
                services.AddHttpClient<IThirdPartyIntegrationService, SecureThirdPartyIntegrationService>()
        ...
        var client = _factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureServices(services =>
            {
                ...
                services.AddScoped<IThirdPartyIntegrationService>(sp =>
                {
                    ...
                    return new ThirdPartyIntegrationService(httpClient, logger, "https://localhost:5001/api/creditscore");
                });
            });
        }).CreateClient();
