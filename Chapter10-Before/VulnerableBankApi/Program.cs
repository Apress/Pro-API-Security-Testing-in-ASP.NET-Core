...
// MISCONFIGURATION: CORS configuration too permissive
builder.Services.AddCors(options =>
{
    options.AddDefaultPolicy(policy =>
    {
        policy.AllowAnyOrigin() // MISCONFIGURATION: Allows any origin
              .AllowAnyHeader() // MISCONFIGURATION: Allows any header
              .AllowAnyMethod() // MISCONFIGURATION: Allows any HTTP method
              .WithExposedHeaders("*"); // MISCONFIGURATION: Exposes all headers
    });
});
...
app.UseCors(); // Using the permissive CORS policy
    ...
    ClaimsPrincipal user) =>
{
    ...
    {
        // MISCONFIGURATION: Exposing exception details
        return Results.Problem(
            detail: ex.ToString(), // Full exception details
            statusCode: 500,
...
// MISCONFIGURATION: Allowing unnecessary HTTP methods
