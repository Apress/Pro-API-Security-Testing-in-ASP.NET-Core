...
builder.Services.AddRateLimiter(options =>
{
    ...
    //     opt.SegmentsPerWindow = 2; // 10-second segments
    //     opt.QueueLimit = 2;
    // });

    // options.AddTokenBucketLimiter("token-bucket", opt =>
    // {
    //     opt.TokenLimit = 2;           // Maximum tokens
    //     opt.TokensPerPeriod = 2;       // Tokens added per period
    ...
    // {
    //     opt.PermitLimit = 4;    // Maximum concurrent requests
    //     opt.QueueLimit = 4;    // Additional requests to queue
    // });
